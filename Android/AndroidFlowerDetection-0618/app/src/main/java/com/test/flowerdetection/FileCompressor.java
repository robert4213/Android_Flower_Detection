...
public class FileCompressor {
    ...
    public File compressToFile(File imageFile, String compressedFileName) throws IOException {
        return com.test.flowerdetection.ImageUtil.compressImage(imageFile, maxWidth, maxHeight, compressFormat, quality,
                destinationDirectoryPath + File.separator + compressedFileName);
    }
    public Bitmap compressToBitmap(File imageFile) throws IOException {
        return com.test.flowerdetection.ImageUtil.decodeSampledBitmapFromFile(imageFile, maxWidth, maxHeight);
    }
